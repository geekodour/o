...
|  [[https://github.com/plottertools/hatched][hatched]] | Convert images to plotter-friendly hatched patterns ( pen plotter) | ['Fun'] | Tool |
...
|  [[https://lucia-auth.com/][Lucia]] | Authentication, simple and clean  (TS) |  | Library |
...
|  [[https://github.com/rivo/uniseg][uniseg]] | Unicode Text Segmentation, Word Wrapping, and String Width Calculation in Go |  | Library |
...
|  [[http://websdr.org/][WebSDR]] | A WebSDR is a Software-Defined Radio receiver connected to the internet, allowing many listeners to listen and tune it simultaneously. There's also a good HN thread about it. (Google) | ['Geo', 'Music', 'Analysis'] | Online Tool |
