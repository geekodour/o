...
> This page includes toy projects as well as proper side projects that I've been working on/worked on previously. You might also want to look at the [project ideas](/pages/project_ideas) list, which is basically my random project idea dump.
>
...
I've mentioned it in my [operation plan]({{< relref "masterplan" >}}) that I have basically two frameworks, one for organizing information and another for executing things on that information. These two compliment each other.
