...
#+end_lft
#+begin_coolinks
- Info: [[https://packagephobia.com/][Package Phobia]]
#+end_coolinks
** Python
#+begin_lft
- Urgent AF
...
- Lazy Sunday
  - Experiment w * ahem * new frameworks
    - [[https://news.ycombinator.com/item?id=33218439][htmx]], alpine.js(more) and [[https://svelte.dev/][svelte]](not so much).
...
- Lazy Sunday
  ...
  - Memory profiling is interesting, I never got to try gdb, valgrind and friends properly. So someday/someweek might hack around and see how these can be useful. [[https://github.com/google/sanitizers/wiki/AddressSanitizerComparisonOfMemoryTools][Valgrind and Address sanitizers]], simpler tools like [[https://github.com/koute/bytehound/issues/4#issuecomment-493762691][bytehound]]
#+end_lft
#+begin_coolinks
- Debugging: [[https://godbolt.org/][godbolt]] | [[https://explainshell.com/][explainshell]] | [[https://copy.sh/v86/][Virtual x86 WASM]]
- Reference: [[https://wiki.archlinux.org/title/core_utilities][coreutils]] | [[https://sysctl-explorer.net/][Sysctl Explorer]] | [[https://gitlab.com/procps-ng/procps][procps-ng]]
#+end_coolinks
