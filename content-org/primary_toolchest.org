...
- Create explorable explanations, check [[https://idyll-lang.org/docs][Idyll]]
- Play w [[https://p5js.org/][p5.js]], check [[https://mogoz.geekodour.org/posts/20230326125239-creative_programming/][notes]].
#+end_lft
#+begin_coolinks
- Showcases: [[https://explorabl.es/][Explorable Explanations]] | [[https://github.com/blob42/awesome-explorables][awesome-explorables]]
- Quick tools: [[https://drawingbots.net/][drawingbots]]
#+end_coolinks
...
** Graphics
#+begin_lft
- I have a syllabus entry for [[file:syllabi.org::*🐂 HB05: Computer graphics][HB05]], which has been there for a while
#+end_lft
I have
...
** Data Analysis/Viz
#+begin_lft
- Try viz tools: D3, [[https://microsoft.github.io/SandDance/][SandDance]], ObservablePlots, [[https://vega.github.io/vega/][Vega]], [[https://github.com/plouc/nivo][plouc/nivo]]
