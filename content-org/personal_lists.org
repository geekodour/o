...
Also [[https://twitter.com/michael_nielsen/status/1615093198808027137][see]] [[https://www.acm.org/code-of-ethics?s=35][this]] and [[https://stephango.com/40-questions][this]]
...
** Programming
  ...
  - Links: [[https://web.stanford.edu/~ouster/cgi-bin/sayings.php][Favorite Sayings by ouster]]
** Management
...
- [[https://www.experimental-history.com/p/theres-a-place-for-everyone][There's a place for everyone - by Adam Mastroianni]]
...
* Personal lexicon
:PROPERTIES:
:EXPORT_FILE_NAME: personal_lexicon
:END:
...
[[file:personal_lists.org::*Jargonfile][Jargonfile]].

** Core terms
| Term                              | Meaning                                                                                                                                                                                                                                              |
|-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *ICCES loop*                      | My non-linear workflow for turning curiosity into output: Inspiration, Capture, Consume, Execute and Share. The loop has no fixed start or end. See [[/docs/documents/notetaking/#icces-loop][ICCES Loop]].                                                                                  |
| *Idea Monkeysphere*               | My map of subjects I want to understand, why I want to understand them and roughly how deep I want to go. It is intentionally not a syllabus. See [[file:o.org::*Idea Monkeysphere][Idea Monkeysphere]].                                                |
...
| *Snipes*                          | Questions with which I nerdsnipe myself and keep running in the back of my mind. See [[file:o.org::*Snipes][Snipes]].                                                                                                                                  |
| *Gandhi ₹*                        | My money-game document: income, financial independence, funding and earning without surrendering autonomy. See [[file:o.org::*Gandhi ₹][Gandhi ₹]].                                                                                                    |
| *Deathnote*                       | Public end-of-life instructions and information useful if I "fall in love with death". See [[file:o.org::*Deathnote][Deathnote]].                                                                                                                    |
| *Gears*                           | My personal hardware, software, lifestyle and operational setup inventory. See [[file:o.org::*Gears][Gears]].                                                                                                                                          |
| *Locus*                           | The index of personal systems, sites, notes and repositories that I host publicly. See [[file:o.org::*Locus 🌊][Locus]].                                                                                                                               |
| *Digital Warrior*                 | My collection of practical privacy, security, activism, journalism and archival resources.                                                                                                                                                          |
| *HB-series syllabus*              | My private numbering scheme for goal-shaped syllabi: /Remove database fear/, /Become spiderman/, /Hello Beep Boop HCI/ and so on.                                                                                                                    |
