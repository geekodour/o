...
** Core terms
- *ICCES loop* :: My non-linear workflow for turning curiosity into output:
  Inspiration, Capture, Consume, Execute and Share. The loop has no fixed start
  or end. See [[/docs/documents/notetaking/#icces-loop][ICCES Loop]].
- *Idea Monkeysphere* :: My map of subjects I want to understand, why I want to
  understand them and roughly how deep I want to go. It is intentionally not a
  syllabus. See [[file:o.org::*Idea Monkeysphere][Idea Monkeysphere]].
- *Komputeer Ussah* :: Computer enthusiasm; the playful name for the part of my
  toolchest concerned with using and enjoying physical computers.
- *Bespoke Garbage* :: Custom, strange and imperfect projects made because I
  need them, want to learn from them or simply enjoy building them.
- *right trash* :: A project can be trash and still be the right trash: useful,
  interesting, measurable or aligned with what I want to do.
- *toolchest* :: A curated arsenal of tools. The primary toolchest contains
  tools and workflows I actively use; the secondary toolchest is the candidate
  tool and bookmark backlog whose ideal state is empty.
- *Plumber Manual* :: My emergency Linux and sysadmin runbook for inspection,
  recovery, troubleshooting, networking and operational practices.
- *Snipes* :: Questions with which I nerdsnipe myself and keep running in the
  back of my mind. See [[file:o.org::*Snipes][Snipes]].
- *Gandhi ₹* :: My money-game document: income, financial independence, funding
  and earning without surrendering autonomy. See [[file:o.org::*Gandhi ₹][Gandhi ₹]].
- *Deathnote* :: Public end-of-life instructions and information useful if I
  "fall in love with death". See [[file:o.org::*Deathnote][Deathnote]].
- *Gears* :: My personal hardware, software, lifestyle and operational setup
  inventory. See [[file:o.org::*Gears][Gears]].
- *Locus* :: The index of personal systems, sites, notes and repositories that
  I host publicly. See [[file:o.org::*Locus 🌊][Locus]].
- *Digital Warrior* :: My collection of practical privacy, security, activism,
  journalism and archival resources.
- *HB-series syllabus* :: My private numbering scheme for goal-shaped syllabi:
  /Remove database fear/, /Become spiderman/, /Hello Beep Boop HCI/ and so on.
- *cached/discounted version of me* :: A personal homepage as an incomplete,
  asynchronously available representation of me.
- *self-nerdsnipe* :: Becoming consumed by a technical question I posed to
  myself.
...
- *passive income mafia* :: A deliberately exaggerated network of passive
  income streams.
- *wild thought pool* :: A reservoir of speculative, silly or unconstrained ideas.
- *brain capabilities maxxing* :: Deliberately upgrading memory, calculation
  and general cognitive ability.
- *serious without a suit* :: Doing serious work while rejecting unnecessary
  corporate formality.
- *No knowledge, no worries* :: Entering an unfamiliar domain confidently
  because I expect to learn it quickly.
...
- *garbage / trash* :: Affectionate, self-deprecating terms for my output rather
  than reasons not to make it.

** Voiceprints
- *monie / dem monie* :: Money, usually when mocking the seriousness of
  monetization.
...
- *मानसिक मूठ* :: Roughly "mental wank": raw, self-indulgent thought siphoned
  onto the homepage.
- *Mlon Eusk* :: Spoonerized Elon Musk.
- *froken bamilies suck so mucking fuch* :: Spoonerized "broken families suck
  so fucking much".
- *mega stupid / mega-simp* :: Using =mega-= as a comic intensifier.
- *absolute 0 care* :: Total indifference, expressed as a numeric setting.
- *jellyfish-brained certified cloudhead skinny ol' barman junior the creator
  of garbage III* :: My maximal self-title/persona.
